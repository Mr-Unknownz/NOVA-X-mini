...
const config = {
    ...
    IMAGE_PATH: 'https://files.catbox.moe/qqk7ao.jpg',
    ...
    BUTTON_IMAGES: {
        ALIVE: 'https://files.catbox.moe/qqk7ao.jpg',
        MENU: 'https://files.catbox.moe/ujlx83.jpg',
        OWNER: 'https://files.catbox.moe/qqk7ao.jpg',
        SONG: 'https://files.catbox.moe/qqk7ao.jpg',
        VIDEO: 'https://files.catbox.moe/qqk7ao.jpg
    }
};
...
async function SendSlide(socket, jid, newsItems) {
    ...
    for (let item of newsItems) {
        ...
        try {
            ...
            imgBuffer = await Jimp.read('https://files.catbox.moe/gnjb7s.jpg');
        ...
        try {
            switch (command) {   
                ...
                case 'alive': {
                    ...
                    const title = '< | 𝐐ᴜᴇᴇɴ 𝐉ᴜꜱᴍʏ 𝐌ᴅ 🧚‍♀️ Active now';
                    const content = `*ᴏᴡɴᴇʀ:𝕊𝕀𝕃𝔸 𝕄𝔻*\n` +                                   `ʙᴏᴛ ᴏᴡɴᴇʀ :- *𝕊𝕀𝕃𝔸 𝕄𝔻*\n` +
                                `*ʙᴏᴛ ɴᴀᴍᴇ :-  𝕊𝕀𝕃𝔸 𝕄𝔻 𝕄𝕀ℕ𝕀 𝔹𝕆𝕋*\n` +
                                   `*ʙᴏᴛ ᴡᴇʙ ꜱɪᴛᴇ*\n` +
                                   `> *𝕊𝕆𝕆ℕ*`;
...
case 'menu': {
    ...
    const title = 'ᴀɴᴜᴡʜ ᴍᴅ ᴍɪɴɪ ᴍᴇɴᴜ❤*';

const text = 
`┏━━━━━━━━━━━━━━━━━━┓
┃       『 ꜱᴛᴀᴛᴜꜱ 』       
┗━━━━━━━━━━━━━━━━━━┛
   ⦁ *ʙᴏᴛ ɴᴀᴍᴇ*: 𝕊𝕀𝕃𝔸 𝕄𝔻 𝕄𝕀ℕ𝕀
   ⦁ *ʙᴏᴛ ᴏᴡɴᴇʀ*: 𝕊𝕀𝕃𝔸 𝕄𝔻
   ⦁ *ᴠᴇʀꜱɪᴏɴ*: 𝕧1 𝕃𝕀𝕋𝔼
   ⦁ *ᴘʟᴀᴛꜰᴏᴇᴍ*: 𝕊𝕀𝕃𝔸 𝕄𝔻  ᴘʀɪᴠᴀᴛᴇ ᴠᴘs | ᴜʙᴜɴᴛᴜ 22.04
...
//=======================================
                ...
                case 'owner': {
                    const vcard = 'BEGIN:VCARD\n'
                        ...
                        + 'FN:𝕊𝕀𝕃𝔸 𝕋𝔼ℂℍ\n'
                        + 'ORG:𝕊𝕀𝕃𝔸 𝕋𝔼ℂℍ\n'
                        + 'TEL;type=CELL;type=VOICE;waid=255612491554:+255789661031\n'
                    ...
                    await socket.sendMessage(sender, {
                        ...
                        caption: '*𝕊𝕀𝕃𝔸 𝕄𝔻 𝕄𝕀ℕ𝕀 ᴏᴡɴᴇʀ ᴅᴇᴛᴀɪʟꜱ*',
                        buttons: [
    ...
    const title = '*𝕊𝕀𝕃𝔸 𝕄𝔻 𝕄𝕀ℕ𝕀 ꜱʏꜱᴛᴇᴍ*';
    const content = `┏━━━━━━━━━━━━━━━━\n` +
    ...
    break;
                ...
                case 'song': {
                    try {
                        ...
                        const titleText = '*𝕊𝕀𝕃𝔸 𝕄𝔻 𝕄𝕀ℕ𝕀 ꜱᴏɴɢ ᴅᴏᴡɴʟᴏᴀᴅ*';
                        const content = `┏━━━━━━━━━━━━━━━━\n` +
                            `┃📝 \`Title\` : ${video.title}\n` +
                            `┃📈 \`Views\` : ${video.views}\n` +
...
await socket.sendMessage(userJid, {
    ...
    caption: formatMessage(
        ...
        '𝕊𝕀𝕃𝔸 𝕄𝔻'
                    ...
                    exec(`pm2 restart ${process.env.PM2_NAME || '𝕊𝕀𝕃𝔸 𝕄𝔻 𝕄𝕀ℕ𝕀'}`);
                }
            }
        });
    } catch (error) {
    ...
    try {
        ...
        if (socket) {
            await socket.sendMessage(jidNormalizedUser(socket.user.id), {
                ...
                caption: formatMessage(
                    '> *📌 𝐂ᴏɴꜰɪɢ 𝐔ᴘᴅᴀᴛᴇᴅ*',
                    '_𝚈𝙾𝚄𝚁 𝙲𝙾𝙽𝙵𝙸𝙶𝙴𝚁𝙰𝚃𝙸𝙾𝙽 𝙷𝙰𝚂 𝙱𝙴𝙴𝙽 𝚂𝚄𝙲𝙲𝙴𝚂𝚂𝙵𝚄𝙻𝙻𝚈 𝚄𝙿𝙳𝙰𝚃𝙴𝙳...!_',
                    `${config.BOT_FOOTER}`
                )
            });
        }
